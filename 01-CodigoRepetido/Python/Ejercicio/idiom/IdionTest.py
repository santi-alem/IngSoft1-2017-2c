...
class IdionTest(unittest.TestCase):
    def testAddingCustomerShouldNotTakeMoreThan50Milliseconds(self):
        ...
        self.assertTrue(functionTakesLessTimeThan(lambda: customerBook.addCustomerNamed('John Lennon'), 50))
    ...
    def testRemovingCustomerShouldNotTakeMoreThan100Milliseconds(self):
        ...
        self.assertTrue(functionTakesLessTimeThan(lambda: customerBook.removeCustomerNamed('Paul McCartney'), 100))
